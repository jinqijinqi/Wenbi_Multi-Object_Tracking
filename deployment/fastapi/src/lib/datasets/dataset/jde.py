...
class JointDataset(LoadImagesAndLabels):  # for training
    ...
    def __getitem__(self, files_index):
        ...
        # imgname = img_path.split('/')[-3:]
        # print(imgname)
        # cphm = copy.deepcopy(hm)
        # cphm = cphm.reshape((output_h, output_w, -1))
        # path='/root/data/lwb/FairMOT/exp/out/{}'.format(imgname[0])
        # if not os.path.exists(path):
        #     os.makedirs(path)
        # cv2.imwrite(path+'/'+imgname[2], cphm*125)
