  ...
  def __init__(self):
    ...
    self.parser.add_argument('--trainval', action='store_true',
                             help='include validation in training and '
                                  'test on test set')
    self.parser.add_argument('--fp16', default=False, help='train by fp16')
    self.parser.add_argument('--only_reid', default=False, help='only train reid')
    self.parser.add_argument('--only_dect', default=False, help=' only train dect')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/root/data/lwb/FairMOT/datasets')
    ...
    self.parser.add_argument('--iou_weight', type=float, default=0.1,
                             help='loss weight for bbox iou')
