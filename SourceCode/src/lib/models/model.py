...
from .networks.mit import get_pose_net as get_mit
from .networks.mit_nff import get_pose_net as get_mit_nff
from .networks.mix import get_pose_net as get_mix
from .networks.mix_new import get_pose_net as get_mix_new
from .networks.crossformer import get_pose_net as get_cs
from .networks.seg import get_pose_net as get_seg
