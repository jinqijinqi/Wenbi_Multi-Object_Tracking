...
if __name__ == '__main__':
    data_val = '/root/data/lwb/FairMOT/datasets/crowdhuman/images/val'
    label_val = '/root/data/lwb/FairMOT/datasets/crowdhuman/labels_with_ids/val'
    ann_val = '/root/data/lwb/FairMOT/datasets/crowdhuman/annotation_val.odgt'
    data_train = '/root/data/lwb/FairMOT/datasets/crowdhuman/images/train'
    label_train = '/root/data/lwb/FairMOT/datasets/crowdhuman/labels_with_ids/train'
    ann_train = '/root/data/lwb/FairMOT/datasets/crowdhuman/annotation_train.odgt'
